...
const BASE = "/player/mi-club/dashboard/bookings";

export default async function MiClubBookingsPage({
  searchParams,
}: {
  searchParams?: {
    view_mode?: string;
  ...
  return (
    <div className="w-full space-y-6">
      ...
      <ClubBookingsCalendarPanel
        weekLabel={weekLabel}
        prevWeekHref={`${BASE}?view_mode=lista&cursor=${toDateInput(prevWeek)}`}
        nextWeekHref={`${BASE}?view_mode=lista&cursor=${toDateInput(nextWeek)}`}
        buckets={buckets}
