...
import { submitLeagueMatchResultAction } from "@/lib/actions/leagues.actions";
    ...
    <div className="mt-2 rounded-lg border border-gray-200 bg-white px-3 py-2">
      ...
      {!canSubmit ? (
        <p className="mt-1 text-[11px] text-amber-700">
          Disponible cuando el partido este finalizado.
        </p>
      ) : null}

      {open && canSubmit ? (
        <form action={submitLeagueMatchResultAction} className="mt-2 space-y-2">
