...
import { scheduleTournamentPlayoffMatchAction } from "@/lib/actions/tournaments.actions";
...
export function TournamentPlayoffScheduleForm({
  tournamentId,
  playoffMatchId,
  courts,
  defaultDate,
  ...
  if (!teamsReady) {
    return (
      <p className="mt-2 text-[11px] text-amber-700">
        Esperando clasificados del cruce anterior para poder programar.
      </p>
    );
  }
  ...
  return (
    <form action={scheduleTournamentPlayoffMatchAction} className="mt-2 grid gap-2 md:grid-cols-5">
