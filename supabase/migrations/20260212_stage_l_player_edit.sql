-- STAGE L: Player Directory & Profile Editing
-- ==========================================

-- 1) RPC: player_update_profile
-- Allows a player to update their own profile or a guest player they created (if not yet claimed).
-- Does NOT modify phone to avoid unique constraint collisions.
