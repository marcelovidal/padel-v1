-- Agrega p_category al RPC player_create_guest_player
-- para que los invitados creados desde inscripción de torneos/ligas
-- tengan categoría asignada y no fallen la validación de registro.
